...
public class ServicesModule extends AbstractModule {
  ...
  @Provides
  @Singleton
  private IPersonProcessService providePersonService() {
    IPersonProcessService service = ServiceTunnelUtility.createProxy(IPersonProcessService.class, ClientSyncJob.getCurrentSession().getServiceTunnel());
    return service;
  }
